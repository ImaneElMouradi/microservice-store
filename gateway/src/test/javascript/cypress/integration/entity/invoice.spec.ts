...
describe('Invoice e2e test', () => {
  ...
  const invoiceSample = {
    date: '2022-01-04T07:45:07.741Z',
    status: 'ISSUED',
    paymentMethod: 'CASH_ON_DELIVERY',
    paymentDate: '2022-01-04T18:43:40.319Z',
    paymentAmount: 75679,
  };
  ...
  describe('new Invoice page', () => {
    ...
    it('should create an instance of Invoice', () => {
      cy.get(`[data-cy="date"]`).type('2022-01-04T08:43').should('have.value', '2022-01-04T08:43');
      ...
      cy.get(`[data-cy="paymentDate"]`).type('2022-01-04T04:00').should('have.value', '2022-01-04T04:00');
