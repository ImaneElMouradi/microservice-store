...
describe('ProductOrder e2e test', () => {
  ...
  const productOrderSample = { placedDate: '2022-01-04T07:12:38.728Z', status: 'COMPLETED', code: 'paradigm Account adapter' };
  ...
  describe('new ProductOrder page', () => {
    ...
    it('should create an instance of ProductOrder', () => {
      cy.get(`[data-cy="placedDate"]`).type('2022-01-04T13:34').should('have.value', '2022-01-04T13:34');
