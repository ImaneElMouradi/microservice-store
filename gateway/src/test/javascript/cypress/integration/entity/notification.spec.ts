...
describe('Notification e2e test', () => {
  ...
  const notificationSample = {
    date: '2022-01-04T11:02:50.480Z',
    sentDate: '2022-01-04T03:15:53.824Z',
    format: 'PARCEL',
    userId: 94565,
    productId: 69326,
  };
  ...
  describe('new Notification page', () => {
    ...
    it('should create an instance of Notification', () => {
      cy.get(`[data-cy="date"]`).type('2022-01-03T19:20').should('have.value', '2022-01-03T19:20');

      cy.get(`[data-cy="details"]`).type('calculate').should('have.value', 'calculate');

      cy.get(`[data-cy="sentDate"]`).type('2022-01-03T19:25').should('have.value', '2022-01-03T19:25');
