...
```
$ docker image tag gateway antoninoprivitera/gateway
$ docker push antoninoprivitera/gateway
$ docker image tag invoice antoninoprivitera/invoice
$ docker push antoninoprivitera/invoice
$ docker image tag notification antoninoprivitera/notification
$ docker push antoninoprivitera/notification
```
